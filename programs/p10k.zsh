# Generated by Powerlevel10k configuration wizard on 2020-03-09 at 04:59 CST.
...
# round heads, blurred tails, 2 lines, solid, full frame, darkest-ornaments, sparse,
...
() {
  ...
  # Yuumu's custom prompt
  typeset -g POWERLEVEL9K_CUSTOM_NIXOS_VERSION="echo  `nixos-version | awk -F '.' '{printf("%s.%s",$1,$2)}'`-`nix-channel --list | awk -F '-' '{print $2}'`"
  typeset -g POWERLEVEL9K_CUSTOM_NIXOS_VERSION_BACKGROUND=51
  typeset -g POWERLEVEL9K_CUSTOM_TRIPLE="echo  `uname -m`-`uname -s | awk '{print tolower($0)}'`-yuyuko"
  typeset -g POWERLEVEL9K_CUSTOM_TRIPLE_BACKGROUND=161

  # The list of segments shown on the left. Fill it with the most important segments.
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    # =========================[ Line #1 ]=========================
    custom_nixos_version    # my custom nixos version
    custom_triple           # my custom linux triple
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_FOREGROUND=124
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_BACKGROUND=34

  # Status when it's just an error code (e.g., '1'). No need to show it if prompt_char is enabled as
  # it will signify error by turning red.
  typeset -g POWERLEVEL9K_STATUS_ERROR=true
  typeset -g POWERLEVEL9K_STATUS_ERROR_VISUAL_IDENTIFIER_EXPANSION='✘'
  typeset -g POWERLEVEL9K_STATUS_ERROR_FOREGROUND=126
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_FOREGROUND=126
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_BACKGROUND=252

  # Status when some part of a pipe command fails and the overall exit status is also non-zero.
  # It may look like this: 1|0.
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE=true
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_VISUAL_IDENTIFIER_EXPANSION='✘'
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_FOREGROUND=126
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_BACKGROUND=252
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_BACKGROUND=29
  # Context color in SSH without privileges.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND=7
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_BACKGROUND=29
  # Default context color (no privileges, no SSH).
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=7
  typeset -g POWERLEVEL9K_CONTEXT_BACKGROUND=29
